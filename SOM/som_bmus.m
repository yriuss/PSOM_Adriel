function [Bmus,Qerrors, BmusValues] = som_bmus(sMap, sData, which_bmus, mask)
...
while i0+1<=dlen, 
  ...
  Dist = (M)*W1(:,inds) - M*WD(:,inds); % plus dconst for each sample
