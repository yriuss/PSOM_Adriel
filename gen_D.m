...
function D = gen_D(dataset)
    res = load("logs/results/"+dataset+"/multiple/"+"results_layer_2_single_1_fator_1_multiple_1_fator_1.mat");
    ...
    points = [TPR;PPV];
    save("logs/results/"+dataset+"/multiple/pr.mat",'points')
end