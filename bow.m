...
dictionary_opts.type='kmeans'; % 'larfsom'
...
%% pyramid bow histogram chi kernel
do_p_classification_chi_svm
show_results_script

[elements features] =  size(train_data)
sum(train_data(:)==0)/(elements*features)
