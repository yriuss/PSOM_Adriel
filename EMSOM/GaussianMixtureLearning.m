function   [new_means,new_converiances,new_P,log_p_self,liklihood,P_absolute] = GaussianMixtureLearning(x,means,converiances,k,r,MaxIteration,logliklihoodThreshold)
keepLooping = true;
%MaxIteration = 100;
...
while keepLooping
    ...
    [P,P_absolute]  = E_Step(x,liklihood,meanss,converiancess,'no');
